...
/**
 * Displays the Intensity of each Set in a donut, pie, or bar graph
 * @author Brandon Chelstrom
 *
 */

public class IntensityGraph extends PieChart {
    private final Circle innerCircle;
    
    
    public IntensityGraph(ObservableList<Data> pieData) {
        super(pieData);
